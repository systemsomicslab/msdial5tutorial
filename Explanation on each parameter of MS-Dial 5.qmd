...
MS-Dial 4: Utilizes the score calculation below.

MS-Dial 5 (versions released before July): Utilizes square of the score calculation below.

MS-Dial 5 (versions released after July): Utilizes the score calculation below.

![Score calculation](images/Parameters for MS-Dial/Figure_Score calculations.png)
