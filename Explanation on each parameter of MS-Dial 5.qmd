...
![Overview of the Spectrum deconvolution parameter settings.](images/Determine MS profile or centroid data/Figure 1_Website.png){#fig-6}
...
![Overview of the Identification parameter settings. Selecting lipids for the analysis (A). Setting identification parameters (B).](images/Determine MS profile or centroid data/Figure 1_Website.png){#fig-8}
...
![Overview of the Adduct parameter settings.](images/Determine MS profile or centroid data/Figure 1_Website.png){#fig-9}
...
![Overview of the alignment parameter settings.](images/Determine MS profile or centroid data/Figure 1_Website.png){#fig-10}
...
![Overview of the Isotope tracking parameter settings.](images/Determine MS profile or centroid data/Figure 1_Website.png){#fig-11}
...
![Overview of the export parameter settings](images/Determine MS profile or centroid data/Figure 1_Website.png){#fig-12}
...
![Fill % (A) and S/N average (B) ratio across mass spectrometry data](images/Determine MS profile or centroid data/Figure 1_Website.png){#fig-13}
