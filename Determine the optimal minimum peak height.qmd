...
![Select the index to see the number of peaks in table (A). Select peak height threshold based (B)](images/Determine MS profile or centroid data/Figure 2_Website.png){#fig-1}
