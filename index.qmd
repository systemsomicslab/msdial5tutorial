...
![Figure 3 Startup a project in MS-DIAL5. First select new project to be created (1), next select a location where your project files will be saved (2). You need to direct MS-DIAL5 to your raw data file location and select the corresponding data file format in the scrolling selection list and select the data files you want to process (4).](images/Fig3%20Start%20up%20a%20project%20of%20MS-DIAL5.png)
