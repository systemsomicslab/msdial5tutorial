...
|                                                  | MS-DIAL4               | MS-DIAL5                                                                         |
| ------------------------------------------------ | ---------------------- | -------------------------------------------------------------------------------- |
| Annotation DB                                    | Single for an analysis | Multi DBs for an analysis                                                        |
| Annotation level                                 | Single for an analysis | Multi level annotation for an analysis                                           |
| Annotation candidates                            | Single for an analysis | Top 3 for analysis                                                               |
| *m/z* range used for mass chromatography display | FILLME                 | FILLME                                                                           |
| MS method type                                   | Single for an analysis | Hybrid MS method for an analysis (DDA,SWATH,AIF can be combined for an analysis) |
| Undo/Redo support in "Peak spot table"           | Not supported          | Supported [https://youtu.be/LeI4OpbHV1s](https://youtu.be/LeI4OpbHV1s)           |
