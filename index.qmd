...
After inserting your raw data files, you will be able to further assign identifiers to your measurements by sample type (Sample, Standard, QC, Blank), Class ID (according to your experimental setup), and you can also set the Batch (if you analyzed multiple batches), Analytical order, Dilution factor, or possibly exclude some samples from further data processing.
