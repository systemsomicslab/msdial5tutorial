...
## Console app in action (for Linux)
...
1. Download the latest Console app for Linux ([https://github.com/systemsomicslab/MsdialWorkbench/releases/tag/MSDIAL-v5.5.260319](https://github.com/systemsomicslab/MsdialWorkbench/releases/tag/MSDIAL-v5.5.260319)) with running
    ...
    ```bash
    curl -L -O https://github.com/systemsomicslab/MsdialWorkbench/releases/download/MSDIAL-v5.5.260319/MSDIAL.console.v5.5.260319-2-linux-net8.zip
    ```

2. Create a directory for the Console app and unzip the downloaded file with running

    ```bash
    mkdir msdial5console && mv MSDIAL.console.v5.5.260319-2-linux-net8.zip msdial5console/ && cd msdial5console/ && unzip MSDIAL.console.v5.5.260319-2-linux-net8.zip
    ```
...
6. Run the `MSDIALCUI` command:
    ...
    ```bash
    chmod +x ./MSDIALCUI && ./MSDIALCUI lcms -i zenodo18336159/consoleapp_demo_csvimportfiles.csv -o zenodo18336159/output/ -m zenodo18336159/zenodo18336159_method.txt -p
    ```
